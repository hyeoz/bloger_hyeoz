    ...
    <div className="w-full max-w-4xl mx-auto space-y-6">
      ...
      {fullQuery && (
        <div className="bg-green-50 dark:bg-green-950/30 p-6 rounded-lg border border-green-200 dark:border-green-800">
          ...
          <div className="flex items-center gap-3 p-4 bg-white dark:bg-zinc-900 rounded-lg border border-green-200 dark:border-green-700">
      ...
      <div className="bg-blue-50 dark:bg-blue-950/30 p-6 rounded-lg border border-blue-200 dark:border-blue-800">
        ...
        <ul className="space-y-2 text-sm text-zinc-600 dark:text-zinc-400">
          ...
          <li>• 검색 결과에서 이미지를 우클릭하여 저장할 수 있습니다</li>
      ...
      <div className="bg-white dark:bg-zinc-900 p-6 rounded-lg border border-zinc-200 dark:border-zinc-800">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-sm">
          <div className="p-3 bg-zinc-50 dark:bg-zinc-800 rounded-lg">
            <div className="font-medium text-zinc-900 dark:text-zinc-50">여행</div>
            <div className="text-xs text-zinc-500 mt-1">→ 무한도전 여행</div>
          </div>
          <div className="p-3 bg-zinc-50 dark:bg-zinc-800 rounded-lg">
            <div className="font-medium text-zinc-900 dark:text-zinc-50">맛집</div>
            <div className="text-xs text-zinc-500 mt-1">→ 무한도전 맛집</div>
          </div>
          <div className="p-3 bg-zinc-50 dark:bg-zinc-800 rounded-lg">
            <div className="font-medium text-zinc-900 dark:text-zinc-50">운동</div>
            <div className="text-xs text-zinc-500 mt-1">→ 무한도전 운동</div>
          </div>
        </div>
      </div>
    </div>
